...
Write-Host "========================================"
Write-Host "海外银行流水整合（代号2）"
Write-Host "========================================"
Write-Host ""
Write-Host "请把海外银行流水文件放入 data\input\2 文件夹，命名格式：A-东亚银行-HKD.csv"
Write-Host ""
...
$exitCode = 1
$exePath = Join-Path $PSScriptRoot "海外银行整合.exe"
...
Write-Host ""
if ($exitCode -eq 0) {
    Write-Host "处理完成。请到 data\output 文件夹查看 银行汇总.xlsx"
} else {
